    ...
    <div class="py-12 g">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-5 bg-white border-b border-gray-200 shadow-xl">
                    <div class="w-full">
                        <div>
                            <x-link-button class="my-5 px-10" href="{{ route('constructions.index') }}">
                        ...
                        <form method="POST"
                            ...
                            <div class="mb-6">
                                <label for="text"
                                    class="block mb-2 text-sm font-medium text-gray-600 font-bold">Nombre de la obra</label>
                            ...
                            <div class="mb-6">
                                ...
                                <label class="block mb-2 text-sm font-medium text-gray-600 font-bold">Añadir categoria a la obra</label>
                                   <select id="underline_select" name="category" class="block py-2.5 px-0 w-full text-sm text-gray-500 bg-transparent border border-gray-500 text-gray-900 text-sm
                                   rounded-lg px-2.5 border-gray-200 appearance-none dark:text-gray-400 dark:border-gray-700 focus:outline-none focus:ring-0 focus:border-gray-200 peer">
                            ...
                            <div><label for="text"
                                class="block mb-2 text-sm font-medium text-gray-600 font-bold">Añadir imagen principal</label></div>
